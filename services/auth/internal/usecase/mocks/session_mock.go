...
// Source: github.com/go-park-mail-ru/2026_1_NaNcats/services/auth/internal/usecase (interfaces: SessionUseCase)
//
// Generated by this command:
//
//	mockgen -destination=mocks/session_mock.go -package=mocks github.com/go-park-mail-ru/2026_1_NaNcats/services/auth/internal/usecase SessionUseCase
//
...
func (m *MockSessionUseCase) Create(ctx context.Context, userID int64, role, userAgent string) (domain.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, userID, role, userAgent)
	ret0, _ := ret[0].(domain.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSessionUseCaseMockRecorder) Create(ctx, userID, role, userAgent any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockSessionUseCase)(nil).Create), ctx, userID, role, userAgent)
}
