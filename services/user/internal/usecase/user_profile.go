...
//go:generate mockgen -destination=mocks/user_profile_mock.go -package=mocks github.com/go-park-mail-ru/2026_1_NaNcats/internal/usecase/user UserProfileUseCase
