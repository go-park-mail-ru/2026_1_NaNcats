...
const file_user_user_proto_rawDesc = "" +
	...
	"\fachievements\x18\x01 \x03(\v2\x15.user.UserAchievementR\fachievements2\xd7\b\n" +
	"\vUserService\x12?\n" +
	"\n" +
	...
	"\x13GetUserAchievements\x12 .user.GetUserAchievementsRequest\x1a!.user.GetUserAchievementsResponseB=Z;github.com/go-park-mail-ru/2026_1_NaNcats/shared/proto/userb\x06proto3"
...
var file_user_user_proto_goTypes = []any{
	...
	nil,                                 // 28: user.GetUsersByIDsResponse.UsersEntry
	(*timestamppb.Timestamp)(nil),       // 29: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),               // 30: google.protobuf.Empty
}
var file_user_user_proto_depIdxs = []int32{
	29, // 0: user.ClientProfile.bonus_category_expires_at:type_name -> google.protobuf.Timestamp
	29, // 1: user.ClientProfile.bonus_expires_at:type_name -> google.protobuf.Timestamp
	29, // 2: user.ClientProfile.last_order_date:type_name -> google.protobuf.Timestamp
	29, // 3: user.ClientProfile.premium_expires_at:type_name -> google.protobuf.Timestamp
	...
	28, // 7: user.GetUsersByIDsResponse.users:type_name -> user.GetUsersByIDsResponse.UsersEntry
	29, // 8: user.OnOrderPaidRequest.paid_at:type_name -> google.protobuf.Timestamp
	23, // 9: user.ListAchievementsResponse.achievements:type_name -> user.Achievement
	29, // 10: user.UserAchievement.awarded_at:type_name -> google.protobuf.Timestamp
	...
	30, // 26: user.UserService.ListAchievements:input_type -> google.protobuf.Empty
	25, // 27: user.UserService.GetUserAchievements:input_type -> user.GetUserAchievementsRequest
	3,  // 28: user.UserService.CreateUser:output_type -> user.CreateUserResponse
	30, // 29: user.UserService.CreateClientProfile:output_type -> google.protobuf.Empty
	30, // 30: user.UserService.UpdateProfile:output_type -> google.protobuf.Empty
	7,  // 31: user.UserService.UpdateAvatar:output_type -> user.UpdateAvatarResponse
	9,  // 32: user.UserService.DeleteAvatar:output_type -> user.DeleteAvatarResponse
	12, // 33: user.UserService.GetByID:output_type -> user.GetUserResponse
	12, // 34: user.UserService.GetByEmail:output_type -> user.GetUserResponse
	14, // 35: user.UserService.CheckUserExists:output_type -> user.CheckUserExistsResponse
	16, // 36: user.UserService.GetUserProfile:output_type -> user.GetUserProfileResponse
	30, // 37: user.UserService.UpdateUserRole:output_type -> google.protobuf.Empty
	19, // 38: user.UserService.GetUsersByIDs:output_type -> user.GetUsersByIDsResponse
	21, // 39: user.UserService.ResolvePublicID:output_type -> user.ResolvePublicIDResponse
	30, // 40: user.UserService.OnOrderPaid:output_type -> google.protobuf.Empty
	24, // 41: user.UserService.ListAchievements:output_type -> user.ListAchievementsResponse
	27, // 42: user.UserService.GetUserAchievements:output_type -> user.GetUserAchievementsResponse
