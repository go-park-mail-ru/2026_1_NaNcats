...
type UserServiceClient interface {
	...
	OnOrderPaid(ctx context.Context, in *OnOrderPaidRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *userServiceClient) OnOrderPaid(ctx context.Context, in *OnOrderPaidRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, UserService_OnOrderPaid_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	// Хук, который order-service дёргает при переходе заказа в paid.
	// Обновляет стрик и прогресс ачивок пользователя.
	OnOrderPaid(context.Context, *OnOrderPaidRequest) (*emptypb.Empty, error)
	// Возвращает все ачивки системы.
...
func (UnimplementedUserServiceServer) OnOrderPaid(context.Context, *OnOrderPaidRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method OnOrderPaid not implemented")
}
...
func _UserService_OnOrderPaid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OnOrderPaidRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).OnOrderPaid(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_OnOrderPaid_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).OnOrderPaid(ctx, req.(*OnOrderPaidRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "OnOrderPaid",
			Handler:    _UserService_OnOrderPaid_Handler,
		},
		{
